...
<body class="antialiased bg-[#0a0d11] text-white">
  ...
  {{-- SINGLE FOOTER ONLY — remove any other footer blocks --}}
        ...
        <div class="md:col-span-1">
          ...
          <div class="mt-5 flex items-center gap-3">
            <a href="#" class="p-2 rounded-lg bg-white/5 hover:bg-white/10" aria-label="Instagram">
              <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5Zm0 2a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3H7Zm5 3a5 5 0 1 1 0 10 5 5 0 0 1 0-10Z"/></svg>
            </a>
